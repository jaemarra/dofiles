...
use prodcodes_Gamble_13_100_CPRD_final.dta, clear
rename productname productname_1
rename drugsubstance drugsubstance_1
...
keep if metformin==1
drop metformin
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("Metformin") sheetmodify
...
keep if sulfonylurea==1
drop sulfonylurea
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("Sulfonylurea") sheetmodify
...
keep if dpp==1
drop dpp
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("DPP-4i") sheetmodify
...
keep if glp==1
drop glp
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("GLP-1 RA") sheetmodify
...
keep if insulins_short==1
drop insulins_short
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("Ins-short") sheetmodify
...
keep if insulins_intlong==1
drop insulins_intlong
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("Ins-int_long") sheetmodify
...
keep if tzd==1
drop tzd
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("TZD") sheetmodify
...
keep if otherantidiab==1
drop otherantidiab
export excel prodcode gemscriptcode productname using drugcodes2.xls, sheet("Other") sheetmodify
