...
clear all
capture log close stat_mace_ps
set more off
log using Stat_mace_ps.smcl, name(stat_mace_ps) replace
timer on 1
...
qui psmatch2 trt, outcome(mace) pscore(ps_single) neighbor(1)
