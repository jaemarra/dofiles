//  program:    Stat_arrhyth_diagnostics.do
...
clear all
capture log close Stat_arrhyth_diagnostics
set more off
log using Stat_diagnostics.smcl, name(Stat_arrhyth_diagnostics) replace
timer on 1
...
timer off 1
log close Stat_arrhyth_diagnostics
