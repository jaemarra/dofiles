//  program:    Stat_mace_diagnostics.do
...
clear all
capture log close Stat_mace_diagnostics
set more off
log using Stat_diagnostics.smcl, name(Stat_mace_diagnostics) replace
timer on 1
...
timer off 1
log close Stat_mace_diagnostics
