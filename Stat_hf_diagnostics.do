//  program:    Stat_hf_diagnostics.do
...
clear all
capture log close Stat_hf_diagnostics
set more off
log using Stat_diagnostics.smcl, name(Stat_hf_diagnostics) replace
timer on 1
