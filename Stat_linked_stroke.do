...
clear all
capture log close Stat_linked_stroke
set more off
log using Stat_linked_stroke.smcl, name(Stat_linked_stroke) replace
timer on 1
...
save linked_stroke, replace

*******************************************************COX PROPORTIONAL HAZARDS REGRESSION*******************************************************
//COMPLETE CASE APPROACH
use linked_stroke, clear
quietly {
//Create macros
...
save Stat_linked_stroke_cc, replace
...
save Stat_linked_stroke_mi, replace
