...
set more off
log using Stat_myoinf.smcl, name(Stat_myoinf_tables) replace
timer on 1
...
save Stat_myoinf_mi_index, replace
...
save Stat_myoinf_mi_index3, replace
...
save Stat_myoinf_mi_any, replace
