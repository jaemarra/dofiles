...
set more off
log using Stat_acm.smcl, name(Stat_acm_tables) replace
timer on 1
...
local x=`i'+2
local rowname:word `i' of `matrownames_mi2'
putexcel A1=("Variable") B1=("HR") C1=("SE") D1=("p-value") E1=("LL") F1=("UL") A`x'=("`rowname'") B`x'=(c[`i',1]) C`x'=(c[`i',2]) D`x'=(c[`i',4]) E`x'=(c[`i',5]) F`x'=(c[`i',6])using table2_acm, sheet("Unadj MI Any Aft") modify
}
