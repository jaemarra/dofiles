...
//** check numbers on label list of real dataset as codes may have changed!!
// NB: (MA, MAY 22). See lookup printout--made changes based on my highlights. JMG, please confirm.
**PFLU... ????
...
collapse (max) immunisedate2 indexdate cohortentrydate studyentrydate studyentrydate_cprd2 flu_c flu_i flu_s pneumo_c pneumo_i ///
				pneumo_s othervaccine_c othervaccine_i othervaccine_s , by(patid)
compress
