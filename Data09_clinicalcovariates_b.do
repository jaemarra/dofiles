...
use `file', clear
//join with hes primary diag hosp. Varlist: patid, spno, icd, icdx, admidate, 
joinby patid spno using hes_primary_diag_hosp, unmatched(master) _merge(hes_primary_diag_hosp_merge)
drop icdx admidate2 discharged2 
